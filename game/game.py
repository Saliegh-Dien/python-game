...
player = pygame.image.load("knight.png")#this image was made by Kilmer & Cruise company and the person was Frank Wessels
enemy = pygame.image.load("cyclops.png")#this image was made by Kilmer & Cruise company and the person was Frank Wessels
enemyB = pygame.image.load("ogre.png")#this image was made by Kilmer & Cruise company and the person was Frank Wessels
enemyC = pygame.image.load("scarecrow.png")#this image was made by Kilmer & Cruise company and the person was Frank Wessels
prize = pygame.image.load("prize.png")#this image was made by free pngimg and can be found at https://freepngimg.com/learning/trophy
...
enemyBYPosition =  random.randint(0, screen_height - enemy_height)

enemyCXPosition =  screen_width
enemyCYPosition =  random.randint(0, screen_height - enemy_height)
...
while 1: # This is a looping structure that will loop the indented code until you tell it to stop(in the event where you exit the program by quitting). In Python the int 1 has the boolean value of 'true'. In fact numbers greater than 0 also do. 0 on the other hand has a boolean value of false. You can test this out with the bool(...) function to see what boolean value types have. You will learn more about while loop structers later. 
    ...
    enemyBBox = pygame.Rect(enemy.get_rect())
    enemyBBox.top = enemyBYPosition
    enemyBBox.left = enemyBXPosition

    enemyCBox = pygame.Rect(enemy.get_rect())
    ...
    if enemyBXPosition < 0 - enemy_width:
    
        # Display wining status to the user: 
        
        print("You win!")
        
    if enemyCXPosition < 0 - enemy_width:
    ...
    enemyXPosition -= 0.25
    enemyBXPosition -= 0.20
    enemyCXPosition -= 0.30
